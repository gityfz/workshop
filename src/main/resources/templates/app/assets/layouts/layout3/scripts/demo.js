...
var Demo = function () {
    ...
    var handleTheme = function () {
        ...
        if ($('.page-head > .container-fluid').size() === 1) {
            $('.theme-setting-layouts', panel).val("fluid");
        } else {
            $('.theme-setting-layouts', panel).val("boxed");
        }
        ...
        var setLayout = function () {
            ...
            var layoutMode = $('.theme-setting-layouts', panel).val();
            ...
            resetLayout(); // reset layouts to default state
    ...
    var setThemeStyle = function(style) {
        ...
        if (typeof Cookies !== "undefined") {
            Cookies.set('layouts-style-option', style);
        }
    };
    ...
    return {
        ...
        init: function() {
            ...
            // handle layouts style change
            $('.theme-panel .theme-setting-style').change(function() {
                 setThemeStyle($(this).val());
            });

            // set layouts style from cookie
            if (typeof Cookies !== "undefined" && Cookies.get('layouts-style-option') === 'rounded') {
                setThemeStyle(Cookies.get('layouts-style-option'));
                $('.theme-panel .layouts-style-option').val(Cookies.get('layouts-style-option'));
            }             
        }
    };
